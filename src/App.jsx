...
function Contact() {
  function handleSubmit(e) {
    ...
    const subject = encodeURIComponent("New Infocus Global Website Enquiry");
  ...
  return (
    <main className="wrap page contactPage">
      <div>
        ...
        <p className="pageLead">
          For managed IT operations, cybersecurity, Microsoft 365, infrastructure,
          cloud or global support enquiries, complete the enquiry form below and it
          will prepare a professional email for our team.
        </p>
